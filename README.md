...
## [b]UPDATE:[/b] Since this tool was released, Peloton updated its connection to Garmin as a two-way synchronization. The implemention works extremely well. I will keep this tool here for those interested in how to connect to Garmin and Peloton using Python, but future development is paused.
